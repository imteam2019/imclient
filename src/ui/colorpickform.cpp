...
ColorPickForm::ColorPickForm(QWidget *parent)
    : MoveableFramelessWindow(parent), ui(new Ui::ColorPickForm) {
  ui->setupUi(this);
  ...
  connect(this, SIGNAL(themColorChanged(QString)), this,
          SLOT(onThemeColorChange(QString)));
  connect(ui->color_panle_pushButton, SIGNAL(clicked()), this,
          SLOT(onColorPanleClick()));
}
...
ColorPickForm::~ColorPickForm() { delete ui; }

QWidget *ColorPickForm::getDragnWidget() { return ui->color_main_top; }
